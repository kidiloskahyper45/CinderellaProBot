...
if START_IMG is None:
    img = "https://telegra.ph/file/27d8af2ee25b448c0ffdf.jpg"
...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya,{} Here..\nHow can I help you? 👩‍✈️".format(bot.first_name),reply_markup=InlineKeyboardMarkup(
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help",callback_data="help_back"),InlineKeyboardButton(text="👸Creator",url="https://t.me/Astronaut_afrina")]]
